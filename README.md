...
Not yet published. When it is, `npm install skiss` gives you the library and a `skiss` command that turns a `.skiss` file into LinkML YAML or a Mermaid diagram.
